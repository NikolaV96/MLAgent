...
public class CARController1 : MonoBehaviour
{
    ...
    public void CreateFitnessLog()
    {
        //print("file gets created?");
        string path = Application.dataPath + "/FitnessLog5.txt";

        if (!File.Exists(path))
        {
            File.WriteAllText(path, "Fitness Log \n\n");
            
        }

        string content = tempFitness.ToString() + "\n";
